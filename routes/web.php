 ...
 *Mexplore
 */
Route::get('artifact/{path?}', [
    'uses' => 'ArtifactController@index',
    // 'as' => 'react',
    'where' => ['path' => '.*']
])->name('artifact');

Route::get('artifact-edit', 'ArtifactEditController@index')->name('artifact-edit');
Route::get('artifact-edit/{id}/edit', 'ArtifactEditController@edit')->name('artifact-edit.edit');
Route::post('artifact-edit/{id}/update', 'ArtifactEditController@update')->name('artifact-edit.update');
Route::get('artifact-edit/tree-folder', 'ArtifactEditController@treeFolder')->name('artifact-edit.tree-folder');
Route::get('artifact-edit/ungdung', 'ArtifactEditController@ungdung')->name('artifact-edit.ungdung');
Route::get('artifact-edit/image', 'ArtifactEditController@image')->name('artifact-edit.image');
Route::post('artifact-edit/upload', 'ArtifactEditController@upload')->name('artifact-edit.upload');
...
Route::prefix('/v2')->group(function () {
    ...
    Route::get('/artifact', 'ArtifactApiController@index')->name('indexArtifact');
    Route::get('/artifact/user', 'ArtifactApiController@getByUserId')->name('getArtifactByUser');
    Route::get('/artifact/detail', 'ArtifactApiController@getByTrealetId')->name('getArtifactById');
